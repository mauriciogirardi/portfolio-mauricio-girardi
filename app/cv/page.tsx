    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="cv-page mx-auto max-w-3xl px-6 py-14">
        <header className="mb-10">
          ...
          <p className="mt-1 text-lg text-muted-foreground">Desenvolvedor Front-End Sênior</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-sm leading-7 text-muted-foreground">
            Desenvolvedor Front-end apaixonado e dedicado, com sólida experiência na criação de
            experiências digitais envolventes e eficientes. Especializado em ReactJS, Next.js,
            Node.js e React Native, com atenção aos detalhes, usabilidade e acessibilidade.
            Confortável em equipes colaborativas e sempre em busca de desafios que impulsionem o
            crescimento e a inovação. Aberto a novos projetos e colaborações profissionais.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
            <h3 className="font-semibold">Bacharelado em Engenharia de Software</h3>
            <span className="font-mono text-xs text-muted-foreground">Início Set 2019</span>
          </div>
          <p className="text-sm text-muted-foreground">
        ...
        <section>
          ...
          <p className="text-sm text-muted-foreground">
            Português — Nativo &nbsp;·&nbsp; Inglês — A2, nível básico (em andamento)
          </p>
        </section>
      </main>
    </div>
